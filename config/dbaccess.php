	...
	function calcTime($secs)
{
	...
	$article = "create table if not exists article ( userName varchar(25) references users(userName) , articleID int primary key auto_increment, textLocation varchar(25) , inputType char(1), category varchar(10), imgLoc varchar(50) , heading varchar(20), timeOfUpload timestamp not null default CURRENT_TIMESTAMP);";
